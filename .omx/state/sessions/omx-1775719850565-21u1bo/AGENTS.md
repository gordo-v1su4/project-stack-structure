...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775719850565-21u1bo | 2026-04-09T07:30:50.656Z

**Codebase Map:**
  src/app/: route, route, route, layout, page
  src/components/: StudioApp, AudioPreview, ParamSlider, ProcessActionBar, SolidWaveform, SourceVideoLibrary, SourceVideoTimeline, SpeedCurve, StudioAudioLane, StudioHeader
  scripts/: bench-compare, bench-latency, preview-section, probe-media
  tests/: bun-test.d, mediaFixtures, studioFixtures, latencyBenchmark.test, manifestRanking.test, mediaFixtures.test, mediaProbe.test, previewAssetRoute.test, previewGeneration.test, audioAnalysis.test
