...
import { getMediaFixturesDir, hasAudioVideoFixtures, listMediaFixtures, mediaFixtureTest } from "../helpers/mediaFixtures";
...
describe("local media fixtures", () => {
  ...
  mediaFixtureTest(hasAudioVideoFixtures())("discovers at least one audio and one video fixture from the local fixture lane", () => {
